...
class VideoAnalyzeTool(Tool):
    ...
    def __init__(self, scene_threshold: float = 30.0, max_keyframes: int = 24) -> None:
    ...
    def run(self, video_path: str = "", **_: object) -> str:
        try:
            keyframes = extract_keyframes(
                video_path, scene_threshold=self.scene_threshold, max_keyframes=self.max_keyframes
            )
